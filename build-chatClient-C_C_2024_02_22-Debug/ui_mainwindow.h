...
public:
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        widgetFrindT->setObjectName("widgetFrindT");
        widgetFrindT->setMaximumSize(QSize(16777215, 30));
        widgetFrindT->setStyleSheet(QString::fromUtf8("    background-color: #5AC8FF;\n"
""));
        ...
        widgetGroupT->setObjectName("widgetGroupT");
        widgetGroupT->setMaximumSize(QSize(16777215, 30));
        widgetGroupT->setStyleSheet(QString::fromUtf8("    background-color: #5AC8FF;\n"
""));
        ...
        widgetConVT->setObjectName("widgetConVT");
        widgetConVT->setMaximumSize(QSize(16777215, 30));
        widgetConVT->setStyleSheet(QString::fromUtf8("    background-color: #5AC8FF;\n"
""));
        ...
        widgetApply->setObjectName("widgetApply");
...
"}"));
        ...
        widgetUserInfo->setObjectName("widgetUserInfo");
        ...
        widgetWinBar->setObjectName("widgetWinBar");
        ...
        QFont font;
        font.setFamilies({QString::fromUtf8("\346\261\211\344\273\252\344\271\220\345\226\265\344\275\223")});
        ...
        labelUserMask->setObjectName("labelUserMask");
        QFont font1;
        font1.setFamilies({QString::fromUtf8("\346\261\211\344\273\252\344\271\220\345\226\265\344\275\223")});
        font1.setPointSize(12);
        labelUserMask->setFont(font1);
        ...
        btnFrind->setObjectName("btnFrind");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resource/images/contacts.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/resource/images/group_normal.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnConversation->setObjectName("btnConversation");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/resource/images/conversation_normal.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnApplay->setObjectName("btnApplay");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/resource/images/applay.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnSysMenu->setObjectName("btnSysMenu");
        btnSysMenu->setMinimumSize(QSize(0, 30));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/resource/common/ic_sysmen.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tbtnAddUser->setObjectName("tbtnAddUser");
        tbtnAddUser->setMinimumSize(QSize(0, 30));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/resource/common/ic_user_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tbtnWeather->setObjectName("tbtnWeather");
        tbtnWeather->setMinimumSize(QSize(0, 30));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/resource/common/ic_weather.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tbtnCalendar->setObjectName("tbtnCalendar");
        tbtnCalendar->setMinimumSize(QSize(0, 30));
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/resource/common/ic_calendar.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QWidget *MainWindow)
    {
        ...
        labelUserName->setText(QCoreApplication::translate("MainWindow", "\344\270\216\344\270\226\347\225\214\346\227\240\351\231\220\347\225\205\350\201\212~", nullptr));
        labelUserMask->setText(QCoreApplication::translate("MainWindow", "\346\234\200\350\207\252\347\224\261\347\232\204\350\201\212\345\244\251\344\275\223\351\252\214", nullptr));
